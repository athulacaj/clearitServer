...
import 'package:clearit_server/screens/getCoins/coinsRequests/viewcoinRequests.dart';
import 'package:clearit_server/screens/getCoins/promocode/promocodesViewScreen.dart';
                ...
                FlatButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => PromocodesViewScreen()));
                  },
                ...
                FlatButton(
                  onPressed: () async {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => ViewCoinRequestsScreen()));
                  },
                  child: Text('Coin requests'),
                ),
              ],
            ),
            SizedBox(height: 30),
