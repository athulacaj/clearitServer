...
class _ReplyScreenState extends State<ReplyScreen> {
  ...
  void initState() {
    _showSpinner = false;
    uploadImage = UploadFileClass(callBack, "reply", context);
    uploadFileList = [];
    isUploading = false;
  ...
  void iconButtonPressed(String type) async {
    ...
    UploadFileClass uploadFile =
        new UploadFileClass(callBack, "reply", context);
